...
\newpage % damit die Aufteilung besser ist
...
\newpage % damit die Bilder keine Lücke in den nachfolgenden Abschnitt reißen
...
\section{Besonderheiten sehr kleiner Rotoren}
\label{sec:low_re}
